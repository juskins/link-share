      ...
      <div className='flex-center gap-2'>
         ...
         <div className='bg-white flex flex-col gap-10 p-10'>
            <div className='flex flex-col gap-2'>
               <h1 className='text-heading font-bold text-[32px]'>Login</h1>
               <p className='text-primaryText'>Add your details below to get back into the app</p>
            </div>
            <form className='text-heading flex flex-col gap-6' onSubmit={handleSubmit}>
               <div className='gap-1 flex flex-col'>
                  <label style={{ color: errors.email && '#FF3939'}}
                  htmlFor="email" className='text-[12px]'>Email address</label>
                  <div className='relative'>
                     ...
                     placeholder='e.g. alex@email.com' onChange={handleEmailChange}
                     style={{ borderColor: errors.email && '#FF3939'}}/>
               ...
               <div className='gap-1 flex flex-col'>
                  <label style={{ color: errors.password && '#FF3939'}} 
                  htmlFor="email" className='text-[12px]'>Enter your password</label>
                  <div className='relative'>
                     <input type="password" value={inputs.password}
                     className='border-border border outline-none  focus:border-btn focus:shadow-myShadow 
                     rounded-radius w-full py-3 px-11 placeholder:text-border' onChange={handlePasswordChange}
                  ...
                  {error && <small className='text-error text-sm'>Wrong email or password</small>}
               </div>  

               <button type='submit' className='bg-btn active:bg-btn-hover active:shadow-myShadow py-[11px]
               rounded-lg text-white px-[27px]'>Login</button>
               <p className='text-[#737373] text-center'>Don't have an account? <span className='text-btn'><Link href='/signup'>Create account</Link></span></p>
            </form>
         </div>
      </div>
    </div>
